            ...
            for (var i = 0; i < local_obj.length; i++) {
                if (local_obj[i].id.toString() === obj_id) {
                    if (!click) {
                        ...
                        $('#task_table').append($('<div class="a cancel"><a style="color: #8b8b8b">x</a></div><h1>' + local_obj[i].title + '</h1></br><p class="underline"><input type="text" id="card_text" placeholder="task title"></p></br><button id="card_add" class="' + obj_id + '">save</button>'));
